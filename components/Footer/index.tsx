              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="/blog?category=insurance" className="mb-3 inline-block hover:text-primary">
                        Insurance
                      </a>
                    </li>
                    <li>
                      <a href="/blog?category=loans" className="mb-3 inline-block hover:text-primary">
                        Loans
                      </a>
                    </li>
                    <li>
                      <a href="/blog?category=credit-cards" className="mb-3 inline-block hover:text-primary">
                        Credit Cards
                      </a>
                    </li>
                  </ul>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://www.facebook.com/share/1H5PXbxibL/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="facebook icon">
                    <svg
                ...
                <li>
                  <a href="https://www.linkedin.com/in/gulraiz-zafar-811876330/" target="_blank" rel="noopener noreferrer" aria-label="linkedin icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
