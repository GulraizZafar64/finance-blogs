      ...
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
        <div className="prose prose-slate dark:prose-invert mx-auto max-w-3xl">
          ...
          <div className="text-body-color dark:text-body-color-dark space-y-6">
            ...
            <p>
              The materials appearing on WealthWiseHub's website could include technical, typographical, or photographic errors. WealthWiseHub does not warrant that any of the materials on its website are accurate, complete, or current. WealthWiseHub may make changes to the materials contained on its website at any time without notice.
            </p>

            <h2 className="text-xl font-semibold text-black dark:text-white mt-8 mb-4">6. Links</h2>
            <p>
              WealthWiseHub has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by WealthWiseHub of the site. Use of any such linked website is at the user's own risk.
            </p>

            <h2 className="text-xl font-semibold text-black dark:text-white mt-8 mb-4">7. Site Terms of Use Modifications</h2>
            <p>
              WealthWiseHub may revise these Terms of Service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these Terms of Service.
            </p>
